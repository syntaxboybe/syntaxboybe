...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&pause=700&color=39ff14&vCenter=true&width=685&height=20&lines=I'm+a+Information+Technology+Student+and+self-taught+dev;Aspiring+Software+Engineer+from+the+Philippines.;~+Cogito,+ergu+sum)](https://git.io/typing-svg)
...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,php,python,java,tailwind,bootstrap,mysql,postman,figma,git,github,vscode)](https://skillicons.dev)
